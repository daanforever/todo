  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved color as @color" do
        ...
        post :create, {:color => { "text" => "invalid value" }}, valid_session
        assigns(:color).should be_a_new(Color)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested color" do
        ...
        Color.any_instance.should_receive(:update_attributes).with({ "text" => "MyString" })
        put :update, {:id => color.to_param, :color => { "text" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the color as @color" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Color.any_instance.stub(:save).and_return(false)
        put :update, {:id => color.to_param, :color => { "text" => "invalid value" }}, valid_session
        assigns(:color).should eq(color)
      end
